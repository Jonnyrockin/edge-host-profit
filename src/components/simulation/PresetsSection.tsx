...
export function PresetsSection({
  ...
  return <div className="grid grid-cols-1 lg:grid-cols-2 gap-panel mb-panel">
      {/* Presets */}
      

      {/* Host Profile */}
      <div className="bg-card border border-border p-panel-padding my-0 py-[11px] mx-0 px-[11px] rounded-none">
