      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3 mt-4">
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="flex items-center gap-1">
            <div className="text-help text-label">Util (effective)</div>
          ...
          <div className="text-help text-label">Live</div>
        </div>
        
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="flex items-center gap-1">
            <div className="text-help text-label">Monthly Calls</div>
          ...
          <div className="text-help text-label">{state.devices.length} device rows</div>
        </div>
        
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="flex items-center gap-1">
            <div className="text-help text-label">Gross (per/mo)</div>
          ...
          <div className="text-help text-label">${calculations.pricePerCall.toFixed(4)} /call</div>
        </div>
        
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="text-help text-label">Platform fee (25%)</div>
          <div className="text-core font-semibold">${Math.round(calculations.platformFee).toLocaleString()}</div>
          <div className="text-help text-label">fee = 25% of gross</div>
        </div>
        
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="text-help text-label">OPEX (per/mo)</div>
          <div className="text-core font-semibold">${Math.round(calculations.opex).toLocaleString()}</div>
          <div className="text-help text-label">energy + rent + staff + misc + lic + fibre</div>
        </div>
        
        <div className="bg-card border border-border rounded-xl p-3 min-h-[86px] flex flex-col">
          <div className="flex items-center gap-1">
            <div className="text-help text-label">Cash Net (per/mo)</div>
          ...
          <div className="text-help text-label">after 25% platform fee + OPEX</div>
        </div>
      </div>
    </div>
  );
